...
* *Languages:* Fluent in Ruby. Prior experience in Python, C, Clojure and Erlang. Working knowledge of Rust.

* Data engineer: Hadoop, Cloudera Impala, HBase

* infrastructure engineer: Chef, Docker, K8S, Nomad, Consul, ZooKeeper, Kafka

* Developer: 
  * worked with multiple programming languages both professionally and on my own time.

* Extensive experience in Linux ecosystem, functional programming and in AWS cloud environment.

* Prior experience building data pipelines, big data systems, applying machine learning and NLP techniques.

* HBase, Hadoop, Storm, Zookeeper, Kafka, RabbitMQ, Vagrant, Vault, multiple orchestrators: k8s, nomad, mesos, Chef, Docker
columnar stores, queues, configuration management systems, containerization

### Professional Summary  (2006 - present)

#### Blippar India Pvt Ltd (Infrastructure Engineer, Apr 2017 - present)
*Technologies:* AWS, Chef, Terraform, Consul, Nomad, Vault, Rancher, Docker, Drone, Kubernetes.
