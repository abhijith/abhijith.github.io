...
*Technologies:* AWS, Chef, Terraform, Consul, Nomad, Vault, Rancher, Docker, Drone, Kubernetes.
  ...
  * Responsible for designing, maintaining, improving the blippar infrastructure and engineering workflows:
    ...
    * Containerization of legacy services with the goal of simplfying workflows and reducing maintenance overhead.

    * Instituted Infrastructure-As-Code using Terraform for provisioning AWS resources.
