...
* *Languages:* Fluent in Ruby. Prior experience in Python, C, Clojure. Working knowledge of Erlang and Golang.
...
*Technologies:* AWS, Chef, Terraform, Consul, Nomad, Vault, Rancher, Docker, Kafka, Kubernetes.
  ...
  * Responsiblities include building, maintaining and improving the microservices platform:

	* Implemented Infrastructure-As-Code with Terraform.

	* Containerization of legacy projects with goal of an unified architecture.

	* Reduced monthly infrastructure spend by ~10%
...
*Styletag 2.0:* Designed a micro-services based e-commerce platform and replaced the SpreeCommerce based system.
  ...
  * Actively identified areas lacking formal business processes and helped formulate better workflows.
...
*Technologies:* C, Ruby, RoR, Ruby-Shoes, Python, Erlang OTP, Mnesia, VMware, Device Mapper, File Systems.
  ...
  * Was instrumental in re-architecting and prototyping the management console using Erlang/OTP and Mnesia.
