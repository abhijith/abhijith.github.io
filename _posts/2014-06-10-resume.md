...
*Styletag 2.0:* Designed a purpose built e-commerce platform and replaced the SpreeCommerce based system.
  ...
  * Designed and developed several components: Catalog management, S-expression based rule engine for Promotions, Cart functionality, Refund/Return system, scenario generation framework for integration testing.
